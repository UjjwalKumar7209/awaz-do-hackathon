...
export default function FinalCTA() {
  ...
  useGSAP(
    () => {
      ...
      .to(btn.querySelector(".icon-container"), {
        rotate: 45,
  ...
  return (
    <section ref={containerRef} className="py-32 md:py-48 px-4 bg-background border-t border-white/10 flex flex-col items-center justify-center text-center">
