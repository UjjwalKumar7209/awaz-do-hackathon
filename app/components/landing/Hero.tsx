...
export default function Hero() {
  ...
  useGSAP(
    () => {
      ...
      gsap.set([headingRef.current, textRef.current, btnRef.current, pillRef.current], {
        y: 100,
        opacity: 0,
      });
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto flex flex-col items-center text-center">
        ...
        >
          Raise<br/>
          <span className="text-transparent" style={{ WebkitTextStroke: "2px white" }}>Your Voice.</span><br/>
          Get Heard.
        </h1>
        ...
        >
          Report civic issues. Get the exact authority to complain to. Generate formal emails instantly. Stop waiting, start resolving.
        </p>

        <button 
          ref={btnRef}
          className="group relative flex items-center gap-4 bg-accent hover:bg-accent-hover text-white px-8 py-5 text-lg font-bold uppercase tracking-wider transition-colors duration-300"
        >
